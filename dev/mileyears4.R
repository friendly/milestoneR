...
plot(density(subset, from=1500, to=1990, bw="sj"), lwd=2.5,
	...
	xlab="Year")
rect(1840, 0, 1910, 0.005, col=grey(.90, alpha=0.4), border=NA)
...
# separate curves for Eur and NAmer

#parts <- split(mileyears, mileyears$where)
#s1 <- mileyears$where == 'NAmer'
#s2 <- mileyears$where == 'Eur'
#sub1 <- years[years>start & s1]
#sub2 <- years[years>start & s2]
#dput(sub1)
...
#fn <- here("figs", "00_1-mileyears4.png")
